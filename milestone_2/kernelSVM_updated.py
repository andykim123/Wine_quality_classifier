...
train_y.loc[2<train_y] = 0
train_y.loc[5<=train_y] = 1
train_y.loc[7<=train_y] = 2
test_y.loc[2<test_y] = 0
test_y.loc[5<=test_y] = 1
test_y.loc[7<=test_y] = 2
...
train_w_y.loc[2<train_w_y] = 0
train_w_y.loc[5<=train_w_y] = 1
train_w_y.loc[7<=train_w_y] = 2
test_w_y.loc[2<test_w_y] = 0
test_w_y.loc[5<=test_w_y] = 1
test_w_y.loc[7<=test_w_y] = 2
cv_w_x = data_white[data_features[:10]]
cv_w_y = data_white[data_features[11]]
cv_w_y.loc[2<cv_w_y] = 0
cv_w_y.loc[5<=cv_w_y] = 1
cv_w_y.loc[7<=cv_w_y] = 2
