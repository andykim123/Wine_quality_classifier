...
# print('SVM 3-class Classification Train Accuracy :: {}'.format(metrics.accuracy_score(train_y_w, clf_white_fit.predict(train_x_w))))
# print('SVM 3-class Classification Test Accuracy :: {}'.format(metrics.accuracy_score(test_y_w, clf_white_fit.predict(test_x_w))))
# print('SVM 3-class CV-prediction error rate :: {}'.format(cross_val_score(clf, cv_x_w, cv_y_w, cv=10)))
